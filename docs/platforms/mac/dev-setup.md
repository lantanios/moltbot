...
https://github.com/lantanios/moltbot/blob/main/apps/macos/README.md
...
1. Reset the TCC permissions:
   ...
   ```
2. If that fails, change the `BUNDLE_ID` temporarily in [`scripts/package-mac-app.sh`](https://github.com/lantanios/moltbot/blob/main/scripts/package-mac-app.sh) to force a "clean slate" from macOS.
