...
Generates HTML release notes from `CHANGELOG.md` (via [`scripts/changelog-to-html.sh`](https://github.com/lantanios/moltbot/blob/main/scripts/changelog-to-html.sh)) and embeds them in the appcast entry.
